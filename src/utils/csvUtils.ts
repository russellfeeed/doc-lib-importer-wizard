  ...
  documents.forEach(doc => {
    ...
    if (isCircularLetter) {
      ...
      row = {
        ...
        'File URL': escapeCsvValue(docFile.fileUrl || `https://dev.members.nsi.org.uk/wp-content/uploads/2025/07/${docFile.name}`),
        'Direct URL': escapeCsvValue(docFile.directUrl || `https://dev.members.nsi.org.uk/wp-content/uploads/2025/07/${docFile.name}`),
